...
def init_game():
    ...
    import pongaibot6
    import pongaibot7
    import finalpongaibot
    import otherpongaibot
    import pongaibot8

    paddles[0].move_getter = chaser_ai.pong_ai # left one
    paddles[1].move_getter = finalpongaibot.pong_ai #directions_from_input #pongaibot.pong_ai # this is the right one
